                ...
                <div class="bg-white rounded-lg shadow p-6 mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="datetime-local" name="purchase_date" value="{{ now()->format('Y-m-d\TH:i') }}" required
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-lg shadow p-6 sticky top-4">
                    ...
                    <div class="space-y-2">
                        ...
                        <a href="{{ route('purchases.index') }}" class="block w-full px-4 py-3 bg-gray-500 text-white rounded-lg hover:bg-gray-600 text-center">
                            Cancel
                        </a>
                    </div>
                </div>

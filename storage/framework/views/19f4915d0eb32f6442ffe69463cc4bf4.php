...
<head>
    ...
    <title>Invoice #<?php echo e($sale->invoice_no ?? $sale->id); ?> - KasseControl</title>
...
<body class="bg-gray-100">
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="no-print mb-4 flex justify-between">
            <a href="<?php echo e(route('sales.show', $sale)); ?>" class="px-4 py-2 bg-gray-500 text-white rounded-lg hover:bg-gray-600">
                ← Back
            </a>
            ...
            <div class="border-b-2 border-gray-300 pb-6 mb-6">
                <div class="flex justify-between items-start">
                    ...
                    <div class="text-right">
                        ...
                        <p class="text-lg"><strong>Invoice #:</strong> <?php echo e($sale->invoice_no ?? str_pad($sale->id, 6, '0', STR_PAD_LEFT)); ?></p>
                        <p class="text-sm text-gray-600">
                            <strong>Date:</strong> <?php echo e($sale->sale_date ? $sale->sale_date->format('M d, Y h:i A') : $sale->created_at->format('M d, Y h:i A')); ?>
            ...
            <div class="grid grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <?php if($sale->customer): ?>
                        <p class="font-semibold text-lg"><?php echo e($sale->customer->name); ?></p>
                        <p class="text-gray-600"><?php echo e($sale->customer->phone); ?></p>
                        <?php if($sale->customer->email): ?>
                            <p class="text-gray-600"><?php echo e($sale->customer->email); ?></p>
                        <?php endif; ?>
                        <?php if($sale->customer->address): ?>
                            <p class="text-gray-600"><?php echo e($sale->customer->address); ?></p>
                        <?php endif; ?>
                    <?php else: ?>
                ...
                <div>
                    ...
                    <p class="font-semibold text-lg"><?php echo e($sale->user->name); ?></p>
                    <p class="text-gray-600"><?php echo e($sale->user->email); ?></p>
                    <p class="text-gray-600 mt-2"><strong>Payment:</strong> <?php echo e(ucfirst($sale->payment_method)); ?></p>
                </div>
            </div>
                ...
                <table class="w-full">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b border-gray-200">
                            ...
                            <td class="px-4 py-3 text-center"><?php echo e(number_format($item->quantity, 2)); ?></td>
                            <td class="px-4 py-3 text-right">$<?php echo e(number_format($item->unit_price, 2)); ?></td>
                            <td class="px-4 py-3 text-right">$<?php echo e(number_format($item->tax, 2)); ?></td>
                            <td class="px-4 py-3 text-right font-semibold">$<?php echo e(number_format($item->total, 2)); ?></td>
                        </tr>
            ...
            <div class="flex justify-end mb-8">
                <div class="w-64">
                    ...
                    <div class="flex justify-between py-2 text-gray-700 bg-green-50 px-3 rounded">
                        <span>Paid:</span>
                        <span class="font-semibold text-green-600">$<?php echo e(number_format($sale->paid, 2)); ?></span>
                    </div>
                    ...
                    <div class="flex justify-between py-2 text-gray-700 bg-orange-50 px-3 rounded mt-1">
                        ...
                        <span class="font-semibold text-orange-600">$<?php echo e(number_format($balance, 2)); ?></span>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
...
<?php /**PATH /home/rakin/github/Projects/KasseControl/resources/views/sales/invoice.blade.php ENDPATH**/ ?>